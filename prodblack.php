...
<html lang="en">
  ...
  <tr>
    <th width="50%" scope="col"><img src="img/black_sock.jpg"></th>
    <th width="50%" align="left" valign="top" scope="col"><h2 class="title">Quackout</h2>
    <p class="price"><b>$10.00</b></p><table width="80%" border="0">
    <a href="addtocart.php?id=1">Add to Cart</a><br>
